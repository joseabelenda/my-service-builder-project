...
public class H7G5EntryServiceHttp {
	...
	private static final Class<?>[] _findByNameParameterTypes1 = new Class[] {
		String.class
	};
	private static final Class<?>[] _findByKeyParameterTypes2 = new Class[] {
		String.class
	};
	private static final Class<?>[] _findByH_D_NParameterTypes3 = new Class[] {
